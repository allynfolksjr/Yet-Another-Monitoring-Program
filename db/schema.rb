...
ActiveRecord::Schema.define(:version => 20130604053029) do
  ...
  add_index "alerts", ["active"], :name => "index_alerts_on_active"
  add_index "alerts", ["base_monitor_id"], :name => "index_alerts_on_base_monitor_id"
